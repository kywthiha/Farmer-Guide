...
public class VerifyNoView extends Fragment {
   ...
   ProgressDialog progressDialog=null;
    ...
    private ImageView loading_iamge;
    View rootView;
    public void setmPhoneNumber(String mPhoneNumber) {
        this.mPhoneNumber = mPhoneNumber.replaceFirst(Pattern.quote("0"),"+95");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        loading_iamge=(ImageView)rootView.findViewById(R.id.verify_code);
        Glide.with(getActivity()).load(R.drawable.verify_code_loading).into(loading_iamge);
        ...
        mVerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(code)) {
                    mVerificationField.setError(getString(R.string.verify_code_error));
                    return;
                }
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                   ...
                   // mPhoneNumberField.setError("Invalid phone number.");
                    ...
                    // [START_EXCLUDE]
                    AlertDialog.Builder show=new AlertDialog.Builder(getActivity()).setTitle(getString(R.string.errr_info))
                            .setMessage(getString(R.string.too_many_request)).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                @Override
    ...
    private void resendVerificationCode(String phoneNumber,
        ...
        progressDialog.setMessage(getString(R.string.resend_verify_code));
